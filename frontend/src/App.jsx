    ...
    return (
      ...
      <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/admindashboard" element={<PrivateRoute isAdmin={isAdmin}> <AdminDashboard /> </PrivateRoute> }/>
            ...
            <Route path="/ProductsAndServices_Display_Row_5" element={<ProductsAndServices_Display_Row_5/>}></Route>
